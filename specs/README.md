...
11. **[`hook-families/tags-accepted-values.md`](hook-families/tags-accepted-values.md)** — **`*-tags-accepted-values`**: allowlist **`config.tags`** only (**`--values`**, **`--optional`**); **spec only** until implemented.
