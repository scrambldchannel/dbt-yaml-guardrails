...
7. **[`hook-families/allowed-meta-keys.md`](hook-families/allowed-meta-keys.md)** — Planned **`*-allowed-meta-keys`** family (e.g. **`model-allowed-meta-keys`**; **`config.meta`** implied; optional **`--allowed`**, plus **`--required`** / **`--forbidden`**).
