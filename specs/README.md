...
8. **[`hook-families/meta-accepted-values.md`](hook-families/meta-accepted-values.md)** — **`*-meta-accepted-values`**: string leaf at a dot path under **`meta`** (**`--key`**, **`--values`**, **`--optional`**); **`model-meta-accepted-values`** shipped; other resources and non-string scalars **later**.
