...
def _run(
    ...
    rows = collect_violation_rows_for_property_paths(
        ...
        config_allowed=SEED_CONFIG_ALLOWED_KEYS,
        config_legacy_key_messages=SEED_CONFIG_LEGACY_KEY_MESSAGES,
...
def main(
    ...
    check_config: str = typer.Option(
        ...
        help=(
            ...
            "same allowlist as seed-allowed-config-keys (default: true). "
    ...
    check_columns: str = typer.Option(
        ...
        help=(
            ...
            "SEED_COLUMN_ALLOWED_KEYS (default: true). "
