...
def _run(
    ...
    rows = collect_violation_rows_for_property_paths(
        ...
        config_allowed=MODEL_CONFIG_ALLOWED_KEYS,
        config_legacy_key_messages=MODEL_CONFIG_LEGACY_KEY_MESSAGES,
        check_columns=check_columns,
        column_allowed=MODEL_COLUMN_ALLOWED_KEYS,
        column_legacy_key_messages=MODEL_COLUMN_LEGACY_KEY_MESSAGES,
...
def main(
    ...
    check_config: str = typer.Option(
        ...
        help=(
            ...
            "same allowlist as model-allowed-config-keys (default: true). "
    ...
    check_columns: str = typer.Option(
        ...
        help=(
            ...
            "MODEL_COLUMN_ALLOWED_KEYS (default: true). "
    ...
    fix_legacy_yaml: str = typer.Option(
        ...
        "--fix-legacy-yaml",
        help=(
            "If true, apply v1 tests→data_tests rewrites in place (ruamel round-trip) "
            "before validation (default: false). See specs/hook-families/fix-legacy-yaml.md."
        ),
    ),
) -> None:
