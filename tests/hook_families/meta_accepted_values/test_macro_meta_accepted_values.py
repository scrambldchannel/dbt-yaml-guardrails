"""Tests for macro-meta-accepted-values CLI (specs/hook-families/meta-accepted-values.md)."""
...
_MACROS = _YAML / "meta_accepted_values" / "macros"
...
def _invoke(*args: str) -> subprocess.CompletedProcess[str]:
    return subprocess.run(
        [
            sys.executable,
            "-m",
            "dbt_yaml_guardrails.hook_families.meta_accepted_values.macro_meta_accepted_values",
            *args,
        ],
        cwd=_REPO_ROOT,
        capture_output=True,
